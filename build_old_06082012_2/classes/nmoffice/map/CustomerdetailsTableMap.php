...
class CustomerdetailsTableMap extends TableMap {
    ...
    $this->addRelation('Refunds', 'Refunds', RelationMap::ONE_TO_MANY, array('customercode' => 'customercode', ), null, null);
    $this->addRelation('Tranferedbloks', 'Tranferedbloks', RelationMap::ONE_TO_MANY, array('customercode' => 'customercode', ), null, null);
	} // buildRelations()
