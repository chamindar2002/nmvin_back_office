...
class OnlinecustomerTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('PAYMENTSUCCESS', 'Paymentsuccess', 'BOOLEAN', false, null, false);
		$this->addColumn('BLOCKREFNO', 'Blockrefno', 'INTEGER', false, null, 0);
		$this->addColumn('PAIDAMT', 'Paidamt', 'FLOAT', false, null, 0);
		$this->addColumn('PAIDAMTISSUEDRECEIPTSTATUS', 'Paidamtissuedreceiptstatus', 'BOOLEAN', false, null, false);
		$this->addColumn('UTILIZED', 'Utilized', 'BOOLEAN', false, null, false);
