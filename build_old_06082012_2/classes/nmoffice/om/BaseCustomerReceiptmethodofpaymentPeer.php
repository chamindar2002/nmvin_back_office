...
abstract class BaseCustomerReceiptmethodofpaymentPeer {
	...
	const CLASS_DEFAULT = 'nmoffice.CustomerReceiptmethodofpayment';
	...
	/**
	 * An identiy map to hold any loaded instances of CustomerReceiptmethodofpayment objects.
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::REFNO, self::RECEIPTNO, self::RECEIPTSTATUS, self::BANK, self::CHEQUNUMBER, self::CHEQUEDATE, self::AMOUNT, self::DELETED, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::REFNO => 0, self::RECEIPTNO => 1, self::RECEIPTSTATUS => 2, self::BANK => 3, self::CHEQUNUMBER => 4, self::CHEQUEDATE => 5, self::AMOUNT => 6, self::DELETED => 7, ),
	 ...
	 *
	 * @param      CustomerReceiptmethodofpayment $value A CustomerReceiptmethodofpayment object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(CustomerReceiptmethodofpayment $obj, $key = null)
	{
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = CustomerReceiptmethodofpaymentPeer::getOMClass(false);
	...
	public static function doSelectJoinCustomerreceipts(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		CustomerReceiptmethodofpaymentPeer::addSelectColumns($criteria);
		$startcol = (CustomerReceiptmethodofpaymentPeer::NUM_COLUMNS - CustomerReceiptmethodofpaymentPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		CustomerReceiptmethodofpaymentPeer::addSelectColumns($criteria);
		$startcol2 = (CustomerReceiptmethodofpaymentPeer::NUM_COLUMNS - CustomerReceiptmethodofpaymentPeer::NUM_LAZY_LOAD_COLUMNS);

		CustomerreceiptsPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (CustomerreceiptsPeer::NUM_COLUMNS - CustomerreceiptsPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	{
		return $withPrefix ? CustomerReceiptmethodofpaymentPeer::CLASS_DEFAULT : CustomerReceiptmethodofpaymentPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a CustomerReceiptmethodofpayment or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a CustomerReceiptmethodofpayment or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(CustomerReceiptmethodofpaymentPeer::REFNO, $criteria->remove(CustomerReceiptmethodofpaymentPeer::REFNO), $comparison);
	...
	/**
	 * Method to DELETE all rows from the customer_receiptmethodofpayment table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(CustomerReceiptmethodofpaymentPeer::TABLE_NAME, $con);
	...
	/**
	 * Method perform a DELETE on the database, given a CustomerReceiptmethodofpayment or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof CustomerReceiptmethodofpayment) {
	 ...
	 */
	public static function doValidate(CustomerReceiptmethodofpayment $obj, $cols = null)
	{
		$columns = array();
