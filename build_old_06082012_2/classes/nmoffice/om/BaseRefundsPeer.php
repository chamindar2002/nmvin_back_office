...
abstract class BaseRefundsPeer {
	...
	const CLASS_DEFAULT = 'nmoffice.Refunds';
	...
	/**
	 * An identiy map to hold any loaded instances of Refunds objects.
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::REFNO, self::SALEREFNO, self::CUSTOMERCODE, self::LOCATIONCODE, self::PROJECTCODE, self::BLOCKREFNUMBER, self::PAYPLANREFNO, self::REFUNDAMOUNT, self::REFUNDATE, self::DELETED, self::DELETEDBY, self::DELETEDDATE, self::DELETEDTIME, self::ADDEDBY, self::ADDEDDATE, self::ADDEDTIME, self::LASTMODIFIEDBY, self::LASTMODIFIEDDATE, self::LASTMODIFIEDTIME, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::REFNO => 0, self::SALEREFNO => 1, self::CUSTOMERCODE => 2, self::LOCATIONCODE => 3, self::PROJECTCODE => 4, self::BLOCKREFNUMBER => 5, self::PAYPLANREFNO => 6, self::REFUNDAMOUNT => 7, self::REFUNDATE => 8, self::DELETED => 9, self::DELETEDBY => 10, self::DELETEDDATE => 11, self::DELETEDTIME => 12, self::ADDEDBY => 13, self::ADDEDDATE => 14, self::ADDEDTIME => 15, self::LASTMODIFIEDBY => 16, self::LASTMODIFIEDDATE => 17, self::LASTMODIFIEDTIME => 18, ),
	 ...
	 *
	 * @param      Refunds $value A Refunds object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Refunds $obj, $key = null)
	{
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = RefundsPeer::getOMClass(false);
	...
	public static function doSelectJoinCustomerdetails(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		RefundsPeer::addSelectColumns($criteria);
		$startcol = (RefundsPeer::NUM_COLUMNS - RefundsPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		RefundsPeer::addSelectColumns($criteria);
		$startcol2 = (RefundsPeer::NUM_COLUMNS - RefundsPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		SalesPeer::addSelectColumns($criteria);
		$startcol7 = $startcol6 + (SalesPeer::NUM_COLUMNS - SalesPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	{
		return $withPrefix ? RefundsPeer::CLASS_DEFAULT : RefundsPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Refunds or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a Refunds or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(RefundsPeer::REFNO, $criteria->remove(RefundsPeer::REFNO), $comparison);
	...
	/**
	 * Method to DELETE all rows from the refunds table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(RefundsPeer::TABLE_NAME, $con);
	...
	/**
	 * Method perform a DELETE on the database, given a Refunds or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Refunds) {
	 ...
	 */
	public static function doValidate(Refunds $obj, $cols = null)
	{
		$columns = array();
