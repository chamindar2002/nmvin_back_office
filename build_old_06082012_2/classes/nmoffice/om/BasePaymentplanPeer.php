...
abstract class BasePaymentplanPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Refno', 'Projectcode', 'Nofinstallments', 'Description', 'Installamount', 'Rsvfee', 'Downpayment', 'Bankloan', 'Adtnlland', 'Totalpayable', 'Deleted', 'Addedby', 'Addeddate', 'Addedtime', 'Lastmodifiedby', 'Lastmodifieddate', 'Lastmodifiedtime', 'Deletedby', 'Deleteddate', 'Deletedtime', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('refno', 'projectcode', 'nofinstallments', 'description', 'installamount', 'rsvfee', 'downpayment', 'bankloan', 'adtnlland', 'totalpayable', 'deleted', 'addedby', 'addeddate', 'addedtime', 'lastmodifiedby', 'lastmodifieddate', 'lastmodifiedtime', 'deletedby', 'deleteddate', 'deletedtime', ),
		BasePeer::TYPE_COLNAME => array (self::REFNO, self::PROJECTCODE, self::NOFINSTALLMENTS, self::DESCRIPTION, self::INSTALLAMOUNT, self::RSVFEE, self::DOWNPAYMENT, self::BANKLOAN, self::ADTNLLAND, self::TOTALPAYABLE, self::DELETED, self::ADDEDBY, self::ADDEDDATE, self::ADDEDTIME, self::LASTMODIFIEDBY, self::LASTMODIFIEDDATE, self::LASTMODIFIEDTIME, self::DELETEDBY, self::DELETEDDATE, self::DELETEDTIME, ),
		BasePeer::TYPE_FIELDNAME => array ('refno', 'projectcode', 'nofinstallments', 'description', 'installamount', 'rsvfee', 'downpayment', 'bankloan', 'adtnlland', 'totalpayable', 'deleted', 'addedby', 'addeddate', 'addedtime', 'lastmodifiedby', 'lastmodifieddate', 'lastmodifiedtime', 'deletedby', 'deleteddate', 'deletedtime', ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::REFNO => 0, self::PROJECTCODE => 1, self::NOFINSTALLMENTS => 2, self::DESCRIPTION => 3, self::INSTALLAMOUNT => 4, self::RSVFEE => 5, self::DOWNPAYMENT => 6, self::BANKLOAN => 7, self::ADTNLLAND => 8, self::TOTALPAYABLE => 9, self::DELETED => 10, self::ADDEDBY => 11, self::ADDEDDATE => 12, self::ADDEDTIME => 13, self::LASTMODIFIEDBY => 14, self::LASTMODIFIEDDATE => 15, self::LASTMODIFIEDTIME => 16, self::DELETEDBY => 17, self::DELETEDDATE => 18, self::DELETEDTIME => 19, ),
