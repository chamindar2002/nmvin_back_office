...
abstract class BaseBlockedipsPeer {
	...
	const CLASS_DEFAULT = 'nmoffice.Blockedips';
	...
	/**
	 * An identiy map to hold any loaded instances of Blockedips objects.
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::REFNO, self::BLOCKED_IP, self::BLOCKED_EMAIL, self::STATUS, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::REFNO => 0, self::BLOCKED_IP => 1, self::BLOCKED_EMAIL => 2, self::STATUS => 3, ),
	 ...
	 *
	 * @param      Blockedips $value A Blockedips object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Blockedips $obj, $key = null)
	{
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = BlockedipsPeer::getOMClass(false);
	...
	{
		return $withPrefix ? BlockedipsPeer::CLASS_DEFAULT : BlockedipsPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Blockedips or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a Blockedips or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(BlockedipsPeer::REFNO, $criteria->remove(BlockedipsPeer::REFNO), $comparison);
	...
	/**
	 * Method to DELETE all rows from the blockedips table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(BlockedipsPeer::TABLE_NAME, $con);
	...
	/**
	 * Method perform a DELETE on the database, given a Blockedips or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Blockedips) {
	 ...
	 */
	public static function doValidate(Blockedips $obj, $cols = null)
	{
		$columns = array();
