...
abstract class BaseProjectPeer {
	...
	const CLASS_DEFAULT = 'nmoffice.Project';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::PROJECTCODE, self::LOCATIONCODE, self::PROJECTNAME, self::NOFBLOCKS, self::DELETED, self::ADDEDBY, self::ADDEDDATE, self::ADDEDTIME, self::LASTMODIFIEDBY, self::LASTMODIFIEDDATE, self::LASTMODIFIEDTIME, self::DELETEDBY, self::DELETEDDATE, self::DELETEDTIME, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::PROJECTCODE => 0, self::LOCATIONCODE => 1, self::PROJECTNAME => 2, self::NOFBLOCKS => 3, self::DELETED => 4, self::ADDEDBY => 5, self::ADDEDDATE => 6, self::ADDEDTIME => 7, self::LASTMODIFIEDBY => 8, self::LASTMODIFIEDDATE => 9, self::LASTMODIFIEDTIME => 10, self::DELETEDBY => 11, self::DELETEDDATE => 12, self::DELETEDTIME => 13, ),
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(ProjectPeer::PROJECTCODE, $criteria->remove(ProjectPeer::PROJECTCODE), $comparison);
