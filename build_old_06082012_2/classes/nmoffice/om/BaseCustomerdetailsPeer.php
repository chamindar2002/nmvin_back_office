...
abstract class BaseCustomerdetailsPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::CUSTOMERCODE, self::TITLE, self::FAMILYNAME, self::FIRSTNAME, self::ADDRESSLINE1, self::ADDRESSLINE2, self::POSTCODE, self::COUNTRY, self::EMAIL, self::SKYPE, self::LANDLINE, self::MOBILE, self::WORKPHONE, self::FAX, self::PROFFESSION, self::GENDER, self::PASSPORTNO, self::SLADDRESSLINE1, self::SLADDRESSLINE2, self::SLADDRESSLINE3, self::SLLANDLINE, self::SLMOBILE, self::SLCONTACTPERSON, self::ONLINEUSERID, self::DELETED, self::ADDEDBY, self::ADDEDDATE, self::ADDEDTIME, self::LASTMODIFIEDBY, self::LASTMODIFIEDDATE, self::LASTMODIFIEDTIME, self::DELETEDBY, self::DELETEDDATE, self::DELETEDTIME, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::CUSTOMERCODE => 0, self::TITLE => 1, self::FAMILYNAME => 2, self::FIRSTNAME => 3, self::ADDRESSLINE1 => 4, self::ADDRESSLINE2 => 5, self::POSTCODE => 6, self::COUNTRY => 7, self::EMAIL => 8, self::SKYPE => 9, self::LANDLINE => 10, self::MOBILE => 11, self::WORKPHONE => 12, self::FAX => 13, self::PROFFESSION => 14, self::GENDER => 15, self::PASSPORTNO => 16, self::SLADDRESSLINE1 => 17, self::SLADDRESSLINE2 => 18, self::SLADDRESSLINE3 => 19, self::SLLANDLINE => 20, self::SLMOBILE => 21, self::SLCONTACTPERSON => 22, self::ONLINEUSERID => 23, self::DELETED => 24, self::ADDEDBY => 25, self::ADDEDDATE => 26, self::ADDEDTIME => 27, self::LASTMODIFIEDBY => 28, self::LASTMODIFIEDDATE => 29, self::LASTMODIFIEDTIME => 30, self::DELETEDBY => 31, self::DELETEDDATE => 32, self::DELETEDTIME => 33, ),
