...
(
	...
	CONSTRAINT `customerreceipts_FK_4`
...
(
	...
	`saletype` TINYINT default 0 COMMENT '0:office,1:online',
	`salerightoff_amt` FLOAT default 0 COMMENT 'Sale Right Off Amount (discount on full settlement)',
	`salerightoff_status` TINYINT default 0 COMMENT 'Sale Right Off Status',
...
(
	...
	CONSTRAINT `customer_receiptmethodofpayment_FK_1`
		FOREIGN KEY (`receiptno`)
		REFERENCES `customerreceipts` (`receiptno`)
)Type=MyISAM COMMENT='Receipt -Method of payment';
