...
class UserTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('ENABLED', 'Enabled', 'BOOLEAN', true, null, null);
		$this->addColumn('LOGINNAME', 'Loginname', 'VARCHAR', true, 20, null);
	...
	{
    $this->addRelation('UserRoleRef', 'UserRoleRef', RelationMap::ONE_TO_MANY, array('uid' => 'uid', ), null, null);
	} // buildRelations()
