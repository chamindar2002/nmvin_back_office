...
abstract class BaseSales extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->deleted = ($row[$startcol + 13] !== null) ? (boolean) $row[$startcol + 13] : null;
			$this->addedby = ($row[$startcol + 14] !== null) ? (int) $row[$startcol + 14] : null;
			$this->addeddate = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
			$this->addedtime = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
			$this->lastmodifiedby = ($row[$startcol + 17] !== null) ? (int) $row[$startcol + 17] : null;
			$this->lastmodifieddate = ($row[$startcol + 18] !== null) ? (string) $row[$startcol + 18] : null;
			$this->lastmodifiedtime = ($row[$startcol + 19] !== null) ? (string) $row[$startcol + 19] : null;
			$this->deletedby = ($row[$startcol + 20] !== null) ? (int) $row[$startcol + 20] : null;
			$this->deleteddate = ($row[$startcol + 21] !== null) ? (string) $row[$startcol + 21] : null;
			$this->deletedtime = ($row[$startcol + 22] !== null) ? (string) $row[$startcol + 22] : null;
			$this->resetModified();
			...
			return $startcol + 23; // 23 = SalesPeer::NUM_COLUMNS - SalesPeer::NUM_LAZY_LOAD_COLUMNS).
