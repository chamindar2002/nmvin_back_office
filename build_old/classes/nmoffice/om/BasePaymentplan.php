...
abstract class BasePaymentplan extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->totalpayable = ($row[$startcol + 5] !== null) ? (double) $row[$startcol + 5] : null;
			$this->deleted = ($row[$startcol + 6] !== null) ? (boolean) $row[$startcol + 6] : null;
			$this->addedby = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
			$this->addeddate = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->addedtime = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->lastmodifiedby = ($row[$startcol + 10] !== null) ? (int) $row[$startcol + 10] : null;
			$this->lastmodifieddate = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->lastmodifiedtime = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->deletedby = ($row[$startcol + 13] !== null) ? (int) $row[$startcol + 13] : null;
			$this->deleteddate = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
			$this->deletedtime = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
			$this->resetModified();
			...
			return $startcol + 16; // 16 = PaymentplanPeer::NUM_COLUMNS - PaymentplanPeer::NUM_LAZY_LOAD_COLUMNS).
