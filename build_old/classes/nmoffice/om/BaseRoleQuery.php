 ...
 *
 * @method     Role findOneByRid(int $rid) Return the first Role filtered by the rid column
...
abstract class BaseRoleQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'nmwndb', $modelName = 'Role', $modelAlias = null)
	{
