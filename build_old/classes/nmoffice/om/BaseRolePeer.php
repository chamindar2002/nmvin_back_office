...
abstract class BaseRolePeer {
	...
	const CLASS_DEFAULT = 'nmoffice.Role';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::RID, self::NAME, self::DESCRIPTION, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::RID => 0, self::NAME => 1, self::DESCRIPTION => 2, ),
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(RolePeer::RID, $criteria->remove(RolePeer::RID), $comparison);
