...
abstract class BaseUserPeer {
	...
	const CLASS_DEFAULT = 'nmoffice.User';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::UID, self::ENABLED, self::LOGINNAME, self::FAMILYNAME, self::FIRSTNAME, self::PASSWORD, self::DELETED, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::UID => 0, self::ENABLED => 1, self::LOGINNAME => 2, self::FAMILYNAME => 3, self::FIRSTNAME => 4, self::PASSWORD => 5, self::DELETED => 6, ),
