 	 ...
 	 public function execute(){ 
	  	...
	  	if($customerExists == 0){
                  ...
                  if ($newUser = UserManager::getInstance()->addNewUser($email,$fristname,$familyname,$pwd,true)) {
                    ...
                    //--------------------------------------------------------------------------------------
                             $title = "A New Guest Has Been Registerd Online";
                             $emailto = "nimavingreenpark@gmail.com";
                             $emailfrom = "online.nimavingreenpark.com";
                             $subject = "Online Registration";
                             $message = "<strong>$fristname $familyname</strong>";
                             $message .="<br><br>Email: $email,Skype: $skype,Phone:$mobile,$lanline";
                             $message .="<br><br>Address: $addl1,$addl2,$country";
                             $heading = "<h1>A New Guest Has Been Registerd Online</h1>";
