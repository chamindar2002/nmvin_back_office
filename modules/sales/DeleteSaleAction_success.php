...
if(isset($_REQUEST['deleted']))
{
	...
	if($deleted == true){
		...
		$_SESSION['deletesale_success'] = "Sale Deleted Successfully.";
		//echo "x2x $deleted y2y <br>".$_REQUEST['msg_success'];
		
	}
	else{
		//$_REQUEST['msg_error'] = "An Error Occured Trying to Delete Customer.";
		$_SESSION['deletesale_failed'] = "An Error Occured Trying to Delete Sale.";
	}
}
header('Location: index.php?m=sales&a=SalesList');
?>