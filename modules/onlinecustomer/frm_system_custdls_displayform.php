<?php
//echo "<h3>Confirmed Online Customer</h3>";
?>
        ...
        <div class="divroundedcorders5">
            <form method='post' action='?m=onlinecustomer&a=OnlineCustomerDetails' name='frmolcustomerdls' id='frmolcustomerdls'>
                <table class='formstable' border='0'>
                    <tr><td colspan='4'><h3>My Details</h3></td></tr>
                    ...
                    <tr>
                        ...
                        <td colspan='6'>
                            <input type="text" class='reqtextboxmedium' name="passportno" id="passportno" value="<?php echo $passportno; ?>" readonly="readonly">
                        </td>
                    ...
                    <tr>
                        <td colspan='8' align='right'>
                            <input type='hidden' value='true' name='confirmedit_confrmdcustomer' id='confirmedit_confrmdcustomer'>
