...
// Application Name
$appName = "Nimawin Property Developers";
...
if (PHP_OS == "Linux") {
	...
	$appDirectory="/home/ngp/nimavingreenpark.com/backoffice";
  	$appWebPath = "http://online.nimavingreenpark.com/";
  	
} else {
	// Windows - developer machines
	$appDirectory = "C:/xampp/htdocs/nimawin/trunk/web";
	$appWebPath = "http://localhost/nimawin/trunk/web/";
}
...
define("SYSTEM_ID", 1);
// Clinet Name.
define("CLIENT_NAME", "Nimawin Property Developers");

define("ROLEIDFORONLINECUSTOMER",4);
define("MAX_PWD_RCV_ATTEMPTS",3);