...
<head>
<link href="themes/nimavinlantheme/css/formstyles.css" rel="stylesheet" type="text/css" />    
<script src="themes/nimavinlantheme/script/jquery.min.js" type="text/javascript"></script>
...
#apDiv1 {
	...
	height:75px;
	z-index:1;
	background-image: url(themes/nimavinlantheme/images/headerback.png);
}
#apDiv2 {
	position:absolute;
	left:-231px;
...
#apDiv3 {
	...
	height:62px;
	z-index:3;
	background-image: url(themes/nimavinlantheme/images/logo.png);
}
#apDiv4 {
	position:absolute;
	left:62%;
...
<link href="themes/nimavinlantheme/css/nimavin.css" rel="stylesheet" type="text/css" />
