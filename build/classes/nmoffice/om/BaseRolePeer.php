...
abstract class BaseRolePeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Rid', 'Name', 'Description', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('rid', 'name', 'description', ),
        BasePeer::TYPE_COLNAME => array (RolePeer::RID, RolePeer::NAME, RolePeer::DESCRIPTION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('RID', 'NAME', 'DESCRIPTION', ),
        BasePeer::TYPE_FIELDNAME => array ('rid', 'name', 'description', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Rid' => 0, 'Name' => 1, 'Description' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('rid' => 0, 'name' => 1, 'description' => 2, ),
        BasePeer::TYPE_COLNAME => array (RolePeer::RID => 0, RolePeer::NAME => 1, RolePeer::DESCRIPTION => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('RID' => 0, 'NAME' => 1, 'DESCRIPTION' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('rid' => 0, 'name' => 1, 'description' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(RolePeer::RID);
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(RolePeer::RID) && $criteria->keyContainsValue(RolePeer::RID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(RolePeer::RID);
            $value = $criteria->remove(RolePeer::RID);
            if ($value) {
                $selectCriteria->add(RolePeer::RID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(RolePeer::RID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(RolePeer::DATABASE_NAME);
            $criteria->add(RolePeer::RID, $pks, Criteria::IN);
