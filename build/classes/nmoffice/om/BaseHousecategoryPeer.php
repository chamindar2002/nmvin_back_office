...
abstract class BaseHousecategoryPeer
{
    ...
    /**
     * An identity map to hold any loaded instances of Housecategory objects.
     ...
     * e.g. HousecategoryPeer::$fieldNames[HousecategoryPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (HousecategoryPeer::HOUSECATCODE, HousecategoryPeer::DESCRIPTION, HousecategoryPeer::PRICE, HousecategoryPeer::DELETED, HousecategoryPeer::ADDEDBY, HousecategoryPeer::ADDEDDATE, HousecategoryPeer::ADDEDTIME, HousecategoryPeer::LASTMODIFIEDBY, HousecategoryPeer::LASTMODIFIEDDATE, HousecategoryPeer::LASTMODIFIEDTIME, HousecategoryPeer::DELETEDBY, HousecategoryPeer::DELETEDDATE, HousecategoryPeer::DELETEDTIME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('HOUSECATCODE', 'DESCRIPTION', 'PRICE', 'DELETED', 'ADDEDBY', 'ADDEDDATE', 'ADDEDTIME', 'LASTMODIFIEDBY', 'LASTMODIFIEDDATE', 'LASTMODIFIEDTIME', 'DELETEDBY', 'DELETEDDATE', 'DELETEDTIME', ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. HousecategoryPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (HousecategoryPeer::HOUSECATCODE => 0, HousecategoryPeer::DESCRIPTION => 1, HousecategoryPeer::PRICE => 2, HousecategoryPeer::DELETED => 3, HousecategoryPeer::ADDEDBY => 4, HousecategoryPeer::ADDEDDATE => 5, HousecategoryPeer::ADDEDTIME => 6, HousecategoryPeer::LASTMODIFIEDBY => 7, HousecategoryPeer::LASTMODIFIEDDATE => 8, HousecategoryPeer::LASTMODIFIEDTIME => 9, HousecategoryPeer::DELETEDBY => 10, HousecategoryPeer::DELETEDDATE => 11, HousecategoryPeer::DELETEDTIME => 12, ),
        BasePeer::TYPE_RAW_COLNAME => array ('HOUSECATCODE' => 0, 'DESCRIPTION' => 1, 'PRICE' => 2, 'DELETED' => 3, 'ADDEDBY' => 4, 'ADDEDDATE' => 5, 'ADDEDTIME' => 6, 'LASTMODIFIEDBY' => 7, 'LASTMODIFIEDDATE' => 8, 'LASTMODIFIEDTIME' => 9, 'DELETEDBY' => 10, 'DELETEDDATE' => 11, 'DELETEDTIME' => 12, ),
    ...
    {
        $toNames = HousecategoryPeer::getFieldNames($toType);
        $key = isset(HousecategoryPeer::$fieldKeys[$fromType][$name]) ? HousecategoryPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(HousecategoryPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, HousecategoryPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return HousecategoryPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(HousecategoryPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(HousecategoryPeer::DATABASE_NAME);
     ...
     *
     * @param Housecategory $obj A Housecategory object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            HousecategoryPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(HousecategoryPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(HousecategoryPeer::$instances[$key])) {
                return HousecategoryPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (HousecategoryPeer::$instances as $instance) {
          $instance->clearAllReferences(true);
        }
      }
        HousecategoryPeer::$instances = array();
    }
     ...
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     * @return array (Housecategory object, last column rank)
     */
    public static function populateObject($row, $startcol = 0)
    {
        $key = HousecategoryPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = HousecategoryPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + HousecategoryPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = HousecategoryPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return Propel::getDatabaseMap(HousecategoryPeer::DATABASE_NAME)->getTable(HousecategoryPeer::TABLE_NAME);
    }
    ...
    {
        return HousecategoryPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a Housecategory or Criteria object.
     *
    ...
    /**
     * Performs an UPDATE on the database, given a Housecategory or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(HousecategoryPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(HousecategoryPeer::HOUSECATCODE);
            $value = $criteria->remove(HousecategoryPeer::HOUSECATCODE);
            if ($value) {
                $selectCriteria->add(HousecategoryPeer::HOUSECATCODE, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(HousecategoryPeer::TABLE_NAME);
            }
    ...
    /**
     * Deletes all rows from the housecategory table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(HousecategoryPeer::TABLE_NAME, $con, HousecategoryPeer::DATABASE_NAME);
    ...
    /**
     * Performs a DELETE on the database, given a Housecategory or Criteria object OR a primary key value.
     *
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        } elseif ($values instanceof Housecategory) { // it's a model object
