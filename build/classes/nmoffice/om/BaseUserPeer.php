...
abstract class BaseUserPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Uid', 'Enabled', 'Loginname', 'Familyname', 'Firstname', 'Password', 'Deleted', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('uid', 'enabled', 'loginname', 'familyname', 'firstname', 'password', 'deleted', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::UID, UserPeer::ENABLED, UserPeer::LOGINNAME, UserPeer::FAMILYNAME, UserPeer::FIRSTNAME, UserPeer::PASSWORD, UserPeer::DELETED, ),
        BasePeer::TYPE_RAW_COLNAME => array ('UID', 'ENABLED', 'LOGINNAME', 'FAMILYNAME', 'FIRSTNAME', 'PASSWORD', 'DELETED', ),
        BasePeer::TYPE_FIELDNAME => array ('uid', 'enabled', 'loginname', 'familyname', 'firstname', 'password', 'deleted', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Uid' => 0, 'Enabled' => 1, 'Loginname' => 2, 'Familyname' => 3, 'Firstname' => 4, 'Password' => 5, 'Deleted' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('uid' => 0, 'enabled' => 1, 'loginname' => 2, 'familyname' => 3, 'firstname' => 4, 'password' => 5, 'deleted' => 6, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::UID => 0, UserPeer::ENABLED => 1, UserPeer::LOGINNAME => 2, UserPeer::FAMILYNAME => 3, UserPeer::FIRSTNAME => 4, UserPeer::PASSWORD => 5, UserPeer::DELETED => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('UID' => 0, 'ENABLED' => 1, 'LOGINNAME' => 2, 'FAMILYNAME' => 3, 'FIRSTNAME' => 4, 'PASSWORD' => 5, 'DELETED' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('uid' => 0, 'enabled' => 1, 'loginname' => 2, 'familyname' => 3, 'firstname' => 4, 'password' => 5, 'deleted' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserPeer::LOGINNAME);
            $criteria->addSelectColumn(UserPeer::FAMILYNAME);
