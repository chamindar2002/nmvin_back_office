...
/**
 * Base class that represents a row from the 'payment_defaulted_entries' table.
 *
 * Payment defaulted enteries log
 *
 * @package    nmoffice.om
 */
abstract class BasePaymentDefaultedEntries extends BaseObject  implements Persistent {
	 ...
	 * @var        PaymentDefaultedEntriesPeer
	 */
	...
	/**
	 * The value for the blockrefnumber_old field.
	 * @var        int
	 */
	protected $blockrefnumber_old;

	/**
	 * The value for the blockrefnumber_new field.
	 * @var        int
	 */
	protected $blockrefnumber_new;

	/**
	 * The value for the satus field.
	 * @var        int
	 */
	protected $satus;
	...
	/**
	 * Get the [blockrefnumber_old] column value.
	 * previous block reference number
	 * @return     int
	 */
	public function getBlockrefnumberOld()
	{
		return $this->blockrefnumber_old;
	}

	/**
	 * Get the [blockrefnumber_new] column value.
	 * new block reference number
	 * @return     int
	 */
	public function getBlockrefnumberNew()
	{
		return $this->blockrefnumber_new;
	}

	/**
	 * Get the [satus] column value.
	 * 1:listed,2:unlisted,3:new block allocated
	 * @return     int
	 */
	 ...
	 * @return     PaymentDefaultedEntries The current object (for fluent API support)
	 */
	public function setRefno($v)
	{
		...
		if ($this->refno !== $v) {
			$this->refno = $v;
			$this->modifiedColumns[] = PaymentDefaultedEntriesPeer::REFNO;
		}
	...
	public function setCustomercode($v)
	{
		...
		if ($this->customercode !== $v) {
			$this->customercode = $v;
			$this->modifiedColumns[] = PaymentDefaultedEntriesPeer::CUSTOMERCODE;
		}
	...
	public function setSalerefno($v)
	{
		...
		if ($this->salerefno !== $v) {
			$this->salerefno = $v;
			$this->modifiedColumns[] = PaymentDefaultedEntriesPeer::SALEREFNO;
		}
	...
	/**
	 * Set the value of [blockrefnumber_old] column.
	 * previous block reference number
	 * @param      int $v new value
	 * @return     PaymentDefaultedEntries The current object (for fluent API support)
	 */
	public function setBlockrefnumberOld($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->blockrefnumber_old !== $v) {
			$this->blockrefnumber_old = $v;
			$this->modifiedColumns[] = PaymentDefaultedEntriesPeer::BLOCKREFNUMBER_OLD;
		}

		return $this;
	} // setBlockrefnumberOld()

	/**
	 * Set the value of [blockrefnumber_new] column.
	 * new block reference number
	 * @param      int $v new value
	 * @return     PaymentDefaultedEntries The current object (for fluent API support)
	 */
	public function setBlockrefnumberNew($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->blockrefnumber_new !== $v) {
			$this->blockrefnumber_new = $v;
			$this->modifiedColumns[] = PaymentDefaultedEntriesPeer::BLOCKREFNUMBER_NEW;
		}

		return $this;
	} // setBlockrefnumberNew()

	/**
	 * Set the value of [satus] column.
	 * 1:listed,2:unlisted,3:new block allocated
	 * @param      int $v new value
	 * @return     PaymentDefaultedEntries The current object (for fluent API support)
	 */
	public function setSatus($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->satus !== $v) {
			$this->satus = $v;
			$this->modifiedColumns[] = PaymentDefaultedEntriesPeer::SATUS;
		}
	...
	public function setOther1($v)
	{
		...
		if ($this->other1 !== $v) {
			$this->other1 = $v;
			$this->modifiedColumns[] = PaymentDefaultedEntriesPeer::OTHER1;
		}
	...
	public function setOther2($v)
	{
		...
		if ($this->other2 !== $v) {
			$this->other2 = $v;
			$this->modifiedColumns[] = PaymentDefaultedEntriesPeer::OTHER2;
		}
	...
	public function setOther3($v)
	{
		...
		if ($this->other3 !== $v) {
			$this->other3 = $v;
			$this->modifiedColumns[] = PaymentDefaultedEntriesPeer::OTHER3;
		}
	...
	public function setAddedby($v)
	{
		...
		if ($this->addedby !== $v) {
			$this->addedby = $v;
			$this->modifiedColumns[] = PaymentDefaultedEntriesPeer::ADDEDBY;
		}
	...
	public function setAddeddate($v)
	{
		...
		if ( $this->addeddate !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PaymentDefaultedEntriesPeer::ADDEDDATE;
			}
	...
	public function setAddedtime($v)
	{
		...
		if ( $this->addedtime !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PaymentDefaultedEntriesPeer::ADDEDTIME;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->blockrefnumber_old = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->blockrefnumber_new = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->satus = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			...
			return $startcol + 12; // 12 = PaymentDefaultedEntriesPeer::NUM_COLUMNS - PaymentDefaultedEntriesPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating PaymentDefaultedEntries object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = PaymentDefaultedEntriesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				PaymentDefaultedEntriesPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				$con->commit();
				PaymentDefaultedEntriesPeer::addInstanceToPool($this);
				return $affectedRows;
			}
		} catch (PropelException $e) {
			$con->rollBack();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PaymentDefaultedEntriesPeer::doInsert($this, $con);
					...
					$affectedRows += PaymentDefaultedEntriesPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PaymentDefaultedEntriesPeer::doValidate($this, $columns)) !== true) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PaymentDefaultedEntriesPeer::REFNO)) $criteria->add(PaymentDefaultedEntriesPeer::REFNO, $this->refno);
		if ($this->isColumnModified(PaymentDefaultedEntriesPeer::CUSTOMERCODE)) $criteria->add(PaymentDefaultedEntriesPeer::CUSTOMERCODE, $this->customercode);
		if ($this->isColumnModified(PaymentDefaultedEntriesPeer::SALEREFNO)) $criteria->add(PaymentDefaultedEntriesPeer::SALEREFNO, $this->salerefno);
		if ($this->isColumnModified(PaymentDefaultedEntriesPeer::BLOCKREFNUMBER_OLD)) $criteria->add(PaymentDefaultedEntriesPeer::BLOCKREFNUMBER_OLD, $this->blockrefnumber_old);
		if ($this->isColumnModified(PaymentDefaultedEntriesPeer::BLOCKREFNUMBER_NEW)) $criteria->add(PaymentDefaultedEntriesPeer::BLOCKREFNUMBER_NEW, $this->blockrefnumber_new);
		if ($this->isColumnModified(PaymentDefaultedEntriesPeer::SATUS)) $criteria->add(PaymentDefaultedEntriesPeer::SATUS, $this->satus);
		if ($this->isColumnModified(PaymentDefaultedEntriesPeer::OTHER1)) $criteria->add(PaymentDefaultedEntriesPeer::OTHER1, $this->other1);
		if ($this->isColumnModified(PaymentDefaultedEntriesPeer::OTHER2)) $criteria->add(PaymentDefaultedEntriesPeer::OTHER2, $this->other2);
		if ($this->isColumnModified(PaymentDefaultedEntriesPeer::OTHER3)) $criteria->add(PaymentDefaultedEntriesPeer::OTHER3, $this->other3);
		if ($this->isColumnModified(PaymentDefaultedEntriesPeer::ADDEDBY)) $criteria->add(PaymentDefaultedEntriesPeer::ADDEDBY, $this->addedby);
		if ($this->isColumnModified(PaymentDefaultedEntriesPeer::ADDEDDATE)) $criteria->add(PaymentDefaultedEntriesPeer::ADDEDDATE, $this->addeddate);
		if ($this->isColumnModified(PaymentDefaultedEntriesPeer::ADDEDTIME)) $criteria->add(PaymentDefaultedEntriesPeer::ADDEDTIME, $this->addedtime);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PaymentDefaultedEntriesPeer::REFNO, $this->refno);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PaymentDefaultedEntries (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setBlockrefnumberOld($this->blockrefnumber_old);

		$copyObj->setBlockrefnumberNew($this->blockrefnumber_new);

		$copyObj->setSatus($this->satus);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PaymentDefaultedEntries Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     PaymentDefaultedEntriesPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new PaymentDefaultedEntriesPeer();
		}
		return self::$peer;
	}
	...
	public function setCustomerdetails(Customerdetails $v = null)
	{
		...
		if ($v !== null) {
			$v->addPaymentDefaultedEntries($this);
		}
	...
	public function getCustomerdetails(PropelPDO $con = null)
	{
		if ($this->aCustomerdetails === null && ($this->customercode !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aCustomerdetails->addPaymentDefaultedEntriess($this);
			 */
		}
	...
	public function getSales(PropelPDO $con = null)
	{
		if ($this->aSales === null && ($this->salerefno !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aSales->addPaymentDefaultedEntriess($this);
			 */
		}
		return $this->aSales;
	}
